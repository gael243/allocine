 ...
 if(e.target.value ==''){
    ...
    return(
        <ReactBoostrap.Navbar bg="dark" variant="dark" fixed="top" className="navheader">
            <ReactBoostrap.Navbar.Brand href="#home"><img src="https://images.pingidentity.com/image/upload/f_auto,q_auto/ping_dam/content/dam/ping-6-2-assets/images/customer-stories/netflix/Netflix-logo-white.png" width="120px"/></ReactBoostrap.Navbar.Brand>
